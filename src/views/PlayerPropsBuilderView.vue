...
.modal-header>button{width:44px;height:44px}.score-actions>button{min-height:48px}
@media(max-width:460px){.props-hero{padding:18px}.prop-side-row{grid-template-columns:1fr}.prop-side-row>div{height:44px}.advanced-controls summary{align-items:flex-start;flex-direction:column;justify-content:center;padding-top:10px;padding-bottom:10px}.advanced-controls summary b{max-width:none;white-space:normal;text-align:left;line-height:1.4}.selected-header-actions button{min-height:48px;white-space:normal;text-align:center;line-height:1.35}}
...
@media(max-width:460px){.props-page .selected-header-actions button{min-height:48px}.props-page .prop-side-row{grid-template-columns:1fr}.props-page .advanced-controls summary b{max-width:none;white-space:normal}}
</style>
