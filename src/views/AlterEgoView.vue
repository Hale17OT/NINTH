...
.eyebrow,.panel header span,.history header span,.connection,.import-panel small,.metrics span,.metrics small,.advice>i,.responsible,.tabs button,.breakdown-head,.breakdown-row b,.breakdown-row small,.breakdown-row>span,.history>header>b,.slip-summary small,.slip-summary b,.status,.leg-state,.leg>div b,.leg>div small,.leg>strong{font-size:12px!important}.hero>div>p,.message,.empty-state p,.advice p{font-size:13px!important}.import-panel .import-actions button,.import-panel button{min-height:48px;height:auto;font-size:12px!important}li{font-size:13px}li>b{width:32px;height:32px;font-size:12px}.advice b{font-size:14px}.breakdown-row,.leg{min-height:72px}.slip-summary{min-height:92px}
</style>
