...
<style scoped>
.guarantee-page{display:grid;padding-bottom:45px}.guarantee-hero{min-height:440px;display:grid;grid-template-columns:1fr 340px;gap:55px;align-items:center;border-bottom:1px solid var(--line)}h1{margin:18px 0 25px;font-size:clamp(62px,8vw,108px);line-height:.82;letter-spacing:-.085em}h1 i{font-style:normal;color:var(--accent)}.guarantee-hero>div>p{max-width:680px;color:var(--muted);font-size:14px;line-height:1.7}.guarantee-hero aside{min-height:295px;padding:25px;display:flex;flex-direction:column;align-items:flex-start;background:var(--contrast);color:var(--on-contrast);border-top:4px solid var(--accent)}.guarantee-hero aside>span{font:700 12px 'DM Mono';color:var(--accent)}.guarantee-hero aside>.headshot{margin:28px 0 12px}.guarantee-hero aside>b{font-size:18px}.guarantee-hero aside>strong{margin-top:auto;font-size:48px;letter-spacing:-.08em;color:var(--accent)}.guarantee-hero aside>small{font:600 12px 'DM Mono';color:#aeb4aa}.method-warning{margin:24px 0;display:flex;gap:13px;padding:16px;border:1px solid color-mix(in srgb,var(--accent) 40%,var(--line));background:color-mix(in srgb,var(--accent) 7%,var(--surface))}.method-warning svg{color:var(--acid);flex:none}.method-warning b{font-size:14px}.method-warning p{margin:4px 0 0;color:var(--muted);font-size:13px;line-height:1.5}.summary-strip{display:grid;grid-template-columns:repeat(4,1fr);gap:1px;background:var(--line);border:1px solid var(--line)}.summary-strip article{padding:18px;background:var(--surface);display:grid;gap:8px}.summary-strip small,.controls label>span{font:700 12px 'DM Mono';letter-spacing:.07em;color:var(--muted)}.summary-strip b{font-size:26px}.controls{display:grid;grid-template-columns:1.2fr repeat(3,1fr);gap:10px;padding:24px 0 14px}.controls label{display:grid;gap:8px}.controls label>div,.controls select{min-height:48px;height:auto;border:1px solid var(--line);background:var(--surface);color:var(--text)}.controls label>div{display:flex;align-items:center;gap:9px;padding:0 12px}.controls input{width:100%;border:0;outline:0;background:transparent;color:var(--text);font-size:13px}.controls select{width:100%;padding:0 11px;font-size:13px}.guarantee-list{border:1px solid var(--line)}.guarantee-list>header,.guarantee-list>article{display:grid;grid-template-columns:minmax(280px,2fr) repeat(4,minmax(90px,.7fr)) minmax(110px,.8fr);align-items:center;gap:12px;padding:15px 18px}.guarantee-list>header{background:var(--contrast);color:#9ba297;font:700 12px 'DM Mono';letter-spacing:.08em}.guarantee-list>article{min-height:88px;border-bottom:1px solid var(--line)}.guarantee-list>article:last-of-type{border:0}.guarantee-list>article:hover{background:var(--wash)}.player{min-width:0;display:flex;align-items:center;gap:10px}.player>span,.guarantee-list article>div:not(.player){display:grid;gap:4px}.player b{overflow:hidden;font-size:14px;text-overflow:ellipsis;white-space:nowrap}.player small,.guarantee-list article>div small{font:600 12px 'DM Mono';color:var(--muted)}.record strong{font-size:22px;color:var(--accent)}.guarantee-list article>div>b{font-size:15px}.guarantee-list em{justify-self:start;display:flex;align-items:center;gap:5px;padding:7px 8px;font:700 12px 'DM Mono';font-style:normal;background:var(--wash);color:var(--muted)}.guarantee-list em.established{background:color-mix(in srgb,var(--accent) 17%,var(--surface));color:var(--green)}.empty,.error-state{padding:40px;text-align:center;color:var(--muted)}.error-state{margin-top:30px;border:1px solid var(--line)}.error-state b{display:block;margin:10px;color:var(--text)}.pagination{display:flex;align-items:center;justify-content:space-between;padding:14px 0;border-bottom:1px solid var(--line)}.pagination button{min-height:44px;padding:9px 12px;border:1px solid var(--line);background:var(--surface);color:var(--text);font:700 12px 'DM Mono';cursor:pointer}.pagination button:disabled{opacity:.35;cursor:not-allowed}.pagination span{font:700 12px 'DM Mono';color:var(--muted)}footer{padding:18px 0;font:600 12px 'DM Mono';color:var(--muted)}@media(max-width:1050px){.guarantee-list{overflow-x:auto}.guarantee-list>header,.guarantee-list>article{min-width:1000px}.controls{grid-template-columns:repeat(2,1fr)}}@media(max-width:720px){.guarantee-hero{grid-template-columns:1fr;padding:38px 0}.summary-strip{grid-template-columns:repeat(2,1fr)}.controls{grid-template-columns:1fr}.pagination span{font-size:12px}h1{font-size:56px}}
</style>
